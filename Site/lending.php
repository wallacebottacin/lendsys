...
<?php
    ...
    if (isset($_POST["itemforlending"])) {
        ...
        echo "<b>Quantidade disponível: </b>" . $availability ."<br>";
        ...
        echo "<form action='includes/lending.inc.php' method='POST'>
                ...
                <div class='mb-2'>
                    <label for='quantityborrowed' class='form-label'>Quantidade a ser emprestada</label>
                    <input type='number' name='quantityborrowed' class='form-control' id='quantityborrowed' required>
                </div>
                <div class='mb-2'>
                ...
                <button type='submit' name='makelending' class='btn btn-info'>
